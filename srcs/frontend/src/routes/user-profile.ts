...
export default function buildUserProfile(): HTMLDivElement {
	...
	outer.innerHTML = `
		<section class="w-full md:w-1/6 shrink-0 pb-4 md:pb-0 md:pr-4 flex md:flex-col flex-row items-center pt-4 md:pt-10 border-b md:border-b-0 md:border-r border-gray-200 dark:border-gray-700">
		...
		<section class="w-full md:w-5/6 shrink-0 md:shrink md:min-h-0 flex flex-col md:pl-4 pt-4 md:pt-0 md:overflow-y-auto">
			...
			<div class="mt-6 flex flex-col shrink-0">
