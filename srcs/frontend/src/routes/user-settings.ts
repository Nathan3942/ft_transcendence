...
export default function createUserSettingsPage(): HTMLDivElement {
	...
	outer.innerHTML = `
		<div class="pl-6 pt-8 flex items-center gap-3">
			<span class="font-mono font-black text-xl tracking-tight uppercase text-gray-900 dark:text-white">
				▐ User Settings
			</span>
		</div>
		...
		<div class="mt-8 ml-6 max-w-1/3 border-t-2 border-dashed border-gray-300 dark:border-gray-700"></div>
